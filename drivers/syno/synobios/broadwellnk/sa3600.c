...
static
int SA3600InitModuleType(struct synobios_ops *ops)
{
	module_t type_sa3600 = MODULE_T_SA3600;
	module_t *pType = &type_sa3600;
	GPIO_PIN Pin;
...
SYNO_HWMON_SENSOR_TYPE SA3600_thermal_sensor = {
...
SYNO_HWMON_SENSOR_TYPE SA3600_voltage_sensor = {
...
SYNO_HWMON_SENSOR_TYPE SA3600_fan_speed_rpm = {
...
struct model_ops sa3600_ops = {
	.x86_init_module_type = SA3600InitModuleType,
...
struct hwmon_sensor_list sa3600_sensor_list = {
	.thermal_sensor = &SA3600_thermal_sensor,
	.voltage_sensor = &SA3600_voltage_sensor,
	.fan_speed_rpm = &SA3600_fan_speed_rpm,
	.psu_status = NULL,
	.hdd_backplane = NULL,
};
