...
SYNO_HWMON_SENSOR_TYPE RS3621xsp_thermal_sensor = {
...
SYNO_HWMON_SENSOR_TYPE RS3621xsp_voltage_sensor = {
...
SYNO_HWMON_SENSOR_TYPE RS3621xsp_fan_speed_rpm = {
...
SYNO_HWMON_SENSOR_TYPE RS3621xsp_hdd_backplane_status = {
...
static
int RS3621xspInitModuleType(struct synobios_ops *ops)
{
	module_t type_rs3621xsp = MODULE_T_RS3621xsp;
	module_t *pType = &type_rs3621xsp;
	GPIO_PIN Pin;
...
struct model_ops rs3621xsp_ops = {
	.x86_init_module_type = RS3621xspInitModuleType,
...
struct hwmon_sensor_list rs3621xsp_sensor_list = {
        .thermal_sensor = &RS3621xsp_thermal_sensor,
        .voltage_sensor = &RS3621xsp_voltage_sensor,
        .fan_speed_rpm = &RS3621xsp_fan_speed_rpm,
        .psu_status = NULL,
        .hdd_backplane = NULL,
};
