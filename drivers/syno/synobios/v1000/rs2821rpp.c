...
PWM_FAN_SPEED_MAPPING gRS2821rppSpeedMapping[] = {
...
SYNO_HWMON_SENSOR_TYPE RS2821rpp_thermal_sensor = {
...
SYNO_HWMON_SENSOR_TYPE RS2821rpp_voltage_sensor = {
...
SYNO_HWMON_SENSOR_TYPE RS2821rpp_fan_speed_rpm = {
...
SYNO_HWMON_SENSOR_TYPE RS2821rpp_psu_status[] = {
	{
...
SYNO_HWMON_SENSOR_TYPE RS2821rpp_hdd_backplane_status = {
...
int RS2821rppGetBuzzerCleared(unsigned char *buzzer_cleared)
{
...
static
void RS2821rppGpioCleanup(void)
{
...
static
int RS2821rppInitModuleType(struct synobios_ops *ops)
{
	module_t type_RS2821rpp = MODULE_T_RS2821rpp;
	module_t *pType = &type_RS2821rpp;
...
static
int RS2821rppFanSpeedMapping(FAN_SPEED speed)
{
	int iDutyCycle = -1;
	size_t i;

	for( i = 0; i < sizeof(gRS2821rppSpeedMapping)/sizeof(PWM_FAN_SPEED_MAPPING); ++i ) {
		if( gRS2821rppSpeedMapping[i].fanSpeed == speed ) {
			iDutyCycle = gRS2821rppSpeedMapping[i].iDutyCycle;
			break;
		}
	}
...
struct model_ops rs2821rpp_ops = {
	.x86_init_module_type = RS2821rppInitModuleType,
	.x86_fan_speed_mapping = RS2821rppFanSpeedMapping,
	.x86_set_esata_led_status = NULL, /* no esata led */
	.x86_cpufan_speed_mapping = NULL, /* no cpu fan */
	.x86_get_buzzer_cleared = RS2821rppGetBuzzerCleared, 
	.x86_gpio_init = RS2821rppGpioInit,
	.x86_gpio_cleanup = RS2821rppGpioCleanup,
#ifdef CONFIG_SYNO_HWMON_PMBUS
	.x86_get_power_status = V1000RedundantPowerGetPowerStatusByI2C,
#endif /* CONFIG_SYNO_HWMON_PMBUS */
};

struct hwmon_sensor_list rs2821rpp_sensor_list = {
	.thermal_sensor = &RS2821rpp_thermal_sensor,
	.voltage_sensor = &RS2821rpp_voltage_sensor,
	.fan_speed_rpm = &RS2821rpp_fan_speed_rpm,
	.psu_status = RS2821rpp_psu_status,
