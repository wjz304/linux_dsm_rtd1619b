...
static
int FS6500I2CGetPowerInfo(POWER_INFO *power_info)
{
	int ret = -1;
	int err = -1;
...
int FS6500InitModuleType(struct synobios_ops *ops)
{
    module_t type_fs6500 = MODULE_T_FS6500;
    module_t *pType = &type_fs6500;

    module_type_set(pType);
    return 0;
}

struct model_ops fs6500_ops = {
    .x86_init_module_type = FS6500InitModuleType,
    ...
    .x86_get_power_status    = FS6500I2CGetPowerInfo,
    .x86_set_buzzer_clear = xsSetBuzzerClear,
};
SYNO_HWMON_SENSOR_TYPE FS6500_thermal_sensor = {
...
SYNO_HWMON_SENSOR_TYPE FS6500_voltage_sensor = {
...
SYNO_HWMON_SENSOR_TYPE FS6500_fan_speed_rpm = {
...
struct hwmon_sensor_list fs6500_sensor_list = {
        .thermal_sensor = &FS6500_thermal_sensor,
        .voltage_sensor = &FS6500_voltage_sensor,
        .fan_speed_rpm = &FS6500_fan_speed_rpm,
        .psu_status = NULL,
        .hdd_backplane = NULL,
};
