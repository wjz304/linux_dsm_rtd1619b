...
int InitModuleType(struct synobios_ops *ops)
{
	...
	module_t type_ds220j = MODULE_T_DS220j;
	module_t *pType = NULL;
...
/*
 *  DS220j other control
 *
 *  Fan fail		MicroP
 *  HDD green LED	Realtek driver (ahci.c, rtd-1296-synology-ds220j.dts)
 *  Lan LED			Realtek driver (r8169.c, rtd-1296-synology-ds220j.dts)
 *
 */
