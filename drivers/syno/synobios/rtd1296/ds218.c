...
int InitModuleType(struct synobios_ops *ops)
{
	...
	module_t type_218 = MODULE_T_DS218;
	module_t *pType = NULL;
...
static int getCopyButtonStatus(void)
{
 ...
 *  17      Out       Control front panel USB2.0 power
 ...
 *
 *  Fan fail		MicroP
 *  HDD green LED	Realtek driver (ahci.c, rtd-1296-synology-ds218.dts)
 *  Lan LED			Realtek driver (r8169.c, rtd-1296-synology-ds218.dts)
 *
 */
...
void syno_gpio_init(void)
{
	...
	syno_gpio_direction_input(copy_button_detect.gpio_port[0]);
}
