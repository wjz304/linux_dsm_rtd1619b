...
int InitModuleType(struct synobios_ops *ops)
{
	...
	module_t type_218play = MODULE_T_DS218play;
	module_t *pType = NULL;
...
/*
 *  DS218play GPIO config table
 *
 *  Pin     In/Out    Function
 *
 *  16       In       Reset button
 *  10      Out       I2C_SCA, control dimmer
 ...
 *  26      Out       I2C_SCL, control dimmer
 *  18      Out       HDD 1 green LED
 *  19      Out       HDD 2 green LED
 *  85      Out       HDD 1 power enable
 *  86      Out       HDD 2 power enable
 *  87      Out       Control HDD LED
 *  97      Out       HDD 2 orange LED
...
/*
 *  DS218play other control
 *
 *  Fan fail		MicroP
 *  HDD green LED	Realtek driver (ahci.c, rtd-1296-synology-ds218play.dts)
 *  Lan LED			Realtek driver (r8169.c, rtd-1296-synology-ds218play.dts)
 *
 */
...
static SYNO_GPIO_INFO power_led = {
	.nr_gpio		= 1,
	.gpio_port		= {122}, // 21 + 101
	.gpio_polarity	= ACTIVE_HIGH,
};
