...
extern struct model_ops rs18016dxsp_ops;
extern struct model_ops fs3017_ops;
...
#define SZ_UART_ALARM_LED_ON       "@"
#define SZ_UART_ALARM_LED_BLINKING "A"
#define SZ_UART_ALARM_LED_OFF      "B"
