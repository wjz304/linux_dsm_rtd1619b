...
int GetModel(void)
{
	int model = MODEL_FS3017;

	if (!strncmp(gszSynoHWVersion, HW_FS3017, strlen(HW_FS3017))) {
		model = MODEL_FS3017;
	} else if (!strncmp(gszSynoHWVersion, HW_RS18016Dxsp, strlen(HW_RS18016Dxsp))) {
		model = MODEL_RS18016Dxsp;
	}
