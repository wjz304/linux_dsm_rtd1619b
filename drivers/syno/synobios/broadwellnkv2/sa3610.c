...
SYNO_HWMON_SENSOR_TYPE SA3610_voltage_sensor = {
...
SYNO_HWMON_SENSOR_TYPE SA3610_fan_speed_rpm = {
...
SYNO_HWMON_SENSOR_TYPE SA3610_psu_status[2] = {
	{
...
SYNO_HWMON_SENSOR_TYPE SA3610_hdd_backplane_status = {
...
static
int SA3610InitModuleType(struct synobios_ops *ops)
{
	module_t type_sa3610 = MODULE_T_SA3610;
	module_t *pType = &type_sa3610;
	GPIO_PIN Pin;
...
struct model_ops sa3610_ops = {
	.x86_init_module_type = SA3610InitModuleType,
...
struct hwmon_sensor_list sa3610_sensor_list = {
        .thermal_sensor = &SA3610_thermal_sensor,
        .voltage_sensor = &SA3610_voltage_sensor,
        .fan_speed_rpm = &SA3610_fan_speed_rpm,
        .psu_status = SA3610_psu_status,
        .hdd_backplane = &SA3610_hdd_backplane_status,
};
