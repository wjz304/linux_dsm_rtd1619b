...
static
int RS4022xspI2CGetPowerInfo(POWER_INFO *power_info)
{
	int ret = -1;
	int err = -1;
...
static
int RS4022xspInitModuleType(struct synobios_ops *ops)
{
	module_t type_rs4022xsp = MODULE_T_RS4022xsp;
	module_t *pType = &type_rs4022xsp;
	GPIO_PIN Pin;
...
struct model_ops rs4022xsp_ops = {
	.x86_init_module_type = RS4022xspInitModuleType,
	...
	.x86_get_power_status = RS4022xspI2CGetPowerInfo,
