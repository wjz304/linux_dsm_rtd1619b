...
#define GPIO_RS814_BUZZER    44
#define IRQ_RS814_BUTTON_BUZZER (IRQ_AURORA_GPIO_START + GPIO_RS814_BUZZER)
...
struct level_button buzzer_btn = {
	.name = "rs814_button_buzzer",
	.irq = IRQ_RS814_BUTTON_BUZZER,
	.gpio = GPIO_RS814_BUZZER,
	.is_high_pressed = 0,
...
InitModuleType(struct synobios_ops *ops)
{
	...
	module_t type_814 = MODULE_T_RS814;
	module_t *pType = NULL;
