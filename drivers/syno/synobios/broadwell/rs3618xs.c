...
SYNO_HWMON_SENSOR_TYPE RS3618xs_thermal_sensor = {
...
SYNO_HWMON_SENSOR_TYPE RS3618xs_voltage_sensor = {
...
SYNO_HWMON_SENSOR_TYPE RS3618xs_fan_speed_rpm = {
...
SYNO_HWMON_SENSOR_TYPE RS3618xs_hdd_backplane_status = {
...
static
int RS3618xsInitModuleType(struct synobios_ops *ops)
{
	module_t type_rs3618xs = MODULE_T_RS3618xs;
	module_t *pType = &type_rs3618xs;
	GPIO_PIN Pin;
...
struct model_ops rs3618xs_ops = {
	.x86_init_module_type = RS3618xsInitModuleType,
...
struct hwmon_sensor_list rs3618xs_sensor_list = {
	.thermal_sensor = &RS3618xs_thermal_sensor,
	.voltage_sensor = &RS3618xs_voltage_sensor,
	.fan_speed_rpm = &RS3618xs_fan_speed_rpm,
	.psu_status = NULL,
	.hdd_backplane = NULL,
};
