...
SYNO_HWMON_SENSOR_TYPE FS2017_thermal_sensor = {
...
SYNO_HWMON_SENSOR_TYPE FS2017_voltage_sensor = {
...
SYNO_HWMON_SENSOR_TYPE FS2017_fan_speed_rpm = {
...
static
int FS2017InitModuleType(struct synobios_ops *ops)
{
	module_t type_fs2017 = MODULE_T_FS2017;
	module_t *pType = &type_fs2017;
	GPIO_PIN Pin;
...
struct model_ops fs2017_ops = {
	.x86_init_module_type = FS2017InitModuleType,
...
struct hwmon_sensor_list fs2017_sensor_list = {
        .thermal_sensor = &FS2017_thermal_sensor,
        .voltage_sensor = &FS2017_voltage_sensor,
        .fan_speed_rpm = &FS2017_fan_speed_rpm,
        .psu_status = NULL,
        .hdd_backplane = NULL,
};
