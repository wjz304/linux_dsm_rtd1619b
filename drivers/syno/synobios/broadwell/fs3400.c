...
SYNO_HWMON_SENSOR_TYPE FS3400_thermal_sensor = {
...
SYNO_HWMON_SENSOR_TYPE FS3400_voltage_sensor = {
...
SYNO_HWMON_SENSOR_TYPE FS3400_fan_speed_rpm = {
...
static
int FS3400InitModuleType(struct synobios_ops *ops)
{
	module_t type_fs3400 = MODULE_T_FS3400;
	module_t *pType = &type_fs3400;
	GPIO_PIN Pin;
...
struct model_ops fs3400_ops = {
	.x86_init_module_type = FS3400InitModuleType,
...
struct hwmon_sensor_list fs3400_sensor_list = {
        .thermal_sensor = &FS3400_thermal_sensor,
        .voltage_sensor = &FS3400_voltage_sensor,
        .fan_speed_rpm = &FS3400_fan_speed_rpm,
        .psu_status = NULL,
        .hdd_backplane = NULL,
};
