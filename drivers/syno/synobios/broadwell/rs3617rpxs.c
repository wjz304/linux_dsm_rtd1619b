...
SYNO_HWMON_SENSOR_TYPE RS3617rpxs_thermal_sensor = {
...
SYNO_HWMON_SENSOR_TYPE RS3617rpxs_voltage_sensor = {
...
SYNO_HWMON_SENSOR_TYPE RS3617rpxs_fan_speed_rpm = {
...
static
int RS3617rpxsInitModuleType(struct synobios_ops *ops)
{
	module_t type_rs3617rpxs = MODULE_T_RS3617rpxs;
	module_t *pType = &type_rs3617rpxs;
	GPIO_PIN Pin;
...
struct model_ops rs3617rpxs_ops = {
	.x86_init_module_type = RS3617rpxsInitModuleType,
...
struct hwmon_sensor_list rs3617rpxs_sensor_list = {
        .thermal_sensor = &RS3617rpxs_thermal_sensor,
        .voltage_sensor = &RS3617rpxs_voltage_sensor,
        .fan_speed_rpm = &RS3617rpxs_fan_speed_rpm,
        .psu_status = NULL,
        .hdd_backplane = NULL,
};
