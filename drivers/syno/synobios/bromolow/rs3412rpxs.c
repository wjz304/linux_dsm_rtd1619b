...
static
int RS3412rpxsInitModuleType(struct synobios_ops *ops)
{
	module_t type = MODULE_T_RS3412rpxs;
	module_t *pType = &type;
	GPIO_PIN Pin;
...
struct model_ops rs3412rpxs_ops = {
	.x86_init_module_type = RS3412rpxsInitModuleType,
