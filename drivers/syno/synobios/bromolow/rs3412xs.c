...
static
int RS3412xsInitModuleType(struct synobios_ops *ops)
{
	module_t type = MODULE_T_RS3412xs;
	module_t *pType = &type;
	GPIO_PIN Pin;
...
struct model_ops rs3412xs_ops = {
	.x86_init_module_type = RS3412xsInitModuleType,
