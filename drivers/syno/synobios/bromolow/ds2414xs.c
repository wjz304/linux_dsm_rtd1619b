...
static
int DS2414xsInitModuleType(struct synobios_ops *ops)
{
	module_t type = MODULE_T_DS2414xs;
	module_t *pType = &type;
...
struct model_ops ds2414xs_ops = {
	.x86_init_module_type = DS2414xsInitModuleType,
