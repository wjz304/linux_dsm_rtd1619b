...
static
int DS3611xsInitModuleType(struct synobios_ops *ops)
{
	module_t type = MODULE_T_DS3611xs;
	module_t *pType = &type;
...
struct model_ops ds3611xs_ops = {
	.x86_init_module_type = DS3611xsInitModuleType,
