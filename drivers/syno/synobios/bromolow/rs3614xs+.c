...
static
int RS3614xspInitModuleType(struct synobios_ops *ops)
{
	module_t type = MODULE_T_RS3614xsp;
	module_t *pType = &type;
...
SYNO_HWMON_SENSOR_TYPE RS3614xsp_thermal_sensor = {
...
SYNO_HWMON_SENSOR_TYPE RS3614xsp_voltage_sensor = {
...
SYNO_HWMON_SENSOR_TYPE RS3614xsp_fan_speed_rpm = {
...
struct model_ops rs3614xsp_ops = {
	.x86_init_module_type = RS3614xspInitModuleType,
...
struct hwmon_sensor_list rs3614xsp_sensor_list = {
	.thermal_sensor = &RS3614xsp_thermal_sensor,
	.voltage_sensor = &RS3614xsp_voltage_sensor,
	.fan_speed_rpm = &RS3614xsp_fan_speed_rpm,
	.psu_status = NULL,
	.hdd_backplane = NULL,
};
