...
static
int RS3411xsInitModuleType(struct synobios_ops *ops)
{
	module_t type = MODULE_T_RS3411xs;
	module_t *pType = &type;
	GPIO_PIN Pin;
...
struct model_ops rs3411xs_ops = {
	.x86_init_module_type = RS3411xsInitModuleType,
