...
static
int RS3413xspInitModuleType(struct synobios_ops *ops)
{
	module_t type_rs3413xsp = MODULE_T_RS3413xsp;
	module_t *pType = &type_rs3413xsp;
	GPIO_PIN Pin;
...
struct model_ops rs3413xsp_ops = {
	.x86_init_module_type = RS3413xspInitModuleType,
