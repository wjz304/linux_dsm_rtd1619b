...
static
int RS3614rpxsInitModuleType(struct synobios_ops *ops)
{
	module_t type = MODULE_T_RS3614rpxs;
	module_t *pType = &type;
...
SYNO_HWMON_SENSOR_TYPE RS3614rpxs_thermal_sensor = {
...
SYNO_HWMON_SENSOR_TYPE RS3614rpxs_voltage_sensor = {
...
SYNO_HWMON_SENSOR_TYPE RS3614rpxs_fan_speed_rpm = {
...
struct model_ops rs3614rpxs_ops = {
	.x86_init_module_type = RS3614rpxsInitModuleType,
...
struct hwmon_sensor_list rs3614rpxs_sensor_list = {
	.thermal_sensor = &RS3614rpxs_thermal_sensor,
	.voltage_sensor = &RS3614rpxs_voltage_sensor,
	.fan_speed_rpm = &RS3614rpxs_fan_speed_rpm,
	.psu_status = NULL,
	.hdd_backplane = NULL,
};
