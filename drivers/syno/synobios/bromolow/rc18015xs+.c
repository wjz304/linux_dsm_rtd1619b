...
static
int RC18015xspInitModuleType(struct synobios_ops *ops)
{
	module_t type_rc18015xsp = MODULE_T_RC18015xsp;
	module_t *pType = &type_rc18015xsp;
	GPIO_PIN Pin;
...
SYNO_HWMON_SENSOR_TYPE RC18015xsp_thermal_sensor = {
	...
	.sensor[1] = {
		.sensor_name = "ADT1 Local",
	},
	.sensor[2] = {
		.sensor_name = "Remote2",
	},
	.sensor[3] = {
		.sensor_name = "ADT2 Local",
	},
};

SYNO_HWMON_SENSOR_TYPE RC18015xsp_voltage_sensor = {
	...
	.sensor[5] = {
		.sensor_name = "ADT2 V33",
	},
};

SYNO_HWMON_SENSOR_TYPE RC18015xsp_fan_speed_rpm = {
	...
	.sensor[4] = {
		.sensor_name = HWMON_SYS_FAN5_RPM,
	},
	.sensor[5] = {
		.sensor_name = HWMON_SYS_FAN6_RPM,
	},
};

struct model_ops rc18015xsp_ops = {
	.x86_init_module_type = RC18015xspInitModuleType,
...
struct hwmon_sensor_list rc18015xsp_sensor_list = {
	.thermal_sensor = &RC18015xsp_thermal_sensor,
	.voltage_sensor = &RC18015xsp_voltage_sensor,
	.fan_speed_rpm = &RC18015xsp_fan_speed_rpm,
	.psu_status = NULL,
	.hdd_backplane = NULL,
};
