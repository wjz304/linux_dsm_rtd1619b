...
int InitModuleType(struct synobios_ops *ops)
{
	...
	module_t type_219se = MODULE_T_DS219se;
	module_t *pType = NULL;
...
#ifdef MY_DEF_HERE
	return SetDiskLedStatusBy9170GPIO(disknum, status);
#else
	return 0;
#endif /* MY_DEF_HERE*/
}
