...
int EPYC7002SOFSRedundantPowerGetPowerStatusByI2C(POWER_INFO *power_info)
{
	int iRet = -1;
...
#ifdef CONFIG_SYNO_HWMON_PMBUS
int EPYC7002SOFSGetPSUStatusByI2C(SYNO_HWMON_SENSOR_TYPE *psu_status, int iPsuNumber)
{
	int iRet = -1;
...
#endif /* CONFIG_SYNO_SMBUS_HDD_POWERCTL || CONFIG_SYNO_SATA_PWR_CTRL_SMBUS */
#ifdef CONFIG_SYNO_HWMON_PMBUS
			synobios_ops.hwmon_get_psu_status = EPYC7002SOFSGetPSUStatusByI2C;
#endif /* CONFIG_SYNO_HWMON_PMBUS */
