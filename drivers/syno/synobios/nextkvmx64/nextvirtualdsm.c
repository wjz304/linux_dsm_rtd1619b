...
#include "synobios.h"
#include "nextkvmx64_common.h"

// extern function from bromolow_common
extern int Nextkvmx64RedundantPowerGetPowerStatus(POWER_INFO *power_info);
...
struct model_ops virtualdsm_ops = {
	...
	.x86_get_power_status    = Nextkvmx64RedundantPowerGetPowerStatus,
